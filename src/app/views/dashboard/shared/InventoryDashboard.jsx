      ...
      <Grid container spacing={3}>
        ...
        <Grid item sm={4} xs={12}>
          <div className="flex-column h-full">
            <h5 className="mt-0 mb-4 text-muted">Inventory Summary</h5>
            <Card
        ...
        <Grid item sm={6} xs={12}>
          <Card className="px-6 py-4">
            <Grid container spacing={3} alignItems="center">
              <Grid item sm={7} xs={12}>
                <div className="flex justify-between items-center py-3">
                  <h5 className="font-normal text-error">Stockout Items</h5>
                  <h5 className="text-error">234</h5>
                </div>
                <div className="flex justify-between items-center py-3">
                  <h5 className="font-normal">Low Stock Items</h5>
                  <h5>123</h5>
                </div>
                <div className="flex justify-between items-center py-3">
                  <h5 className="font-normal">Available Items</h5>
                  <h5>3432</h5>
                </div>
              </Grid>
            ...
            <div className="flex justify-between items-center p-4">
              ...
              <Select size="small" defaultValue="this_year" disableUnderline>
            ...
            <div className="flex justify-around">
              ...
              <div className="py-3 text-center">
                <p>Total Cost</p>
                <h4 className="text-primary">${(432432).toLocaleString()}</h4>
              </div>
            </div>
          </Card>
        </Grid>
