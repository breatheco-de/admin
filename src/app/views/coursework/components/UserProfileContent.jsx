      ...
      <div className={classes.profileContent}>
            ...
            {projectSummery.map((project) => (
              <Grid item lg={4} md={4} sm={12} xs={12} key={project.title}>
                <Card className="h-96 bg-gray bg-default flex items-center justify-between p-4">
                  <div>
                    <span className="text-light-white uppercase">{project.title}</span>
                    <h4 className="font-normal text-white m-0 pt-2">{project.amount}</h4>
                  </div>
        ...
        <Grid container spacing={3}>
          <Grid item lg={8} md={8} sm={12} xs={12}>
            <Card className="pb-4">
              <h4 className="font-medium text-muted px-4 pt-4 pb-0">Data Use</h4>
              ...
              <div className="pt-4 flex items-center justify-around">
                <div>
                  ...
                  <span className="font-normal text-muted uppercase">avg yearly</span>
                </div>
                <div>
                  <h1 className="font-normal m-0 mb-1">12</h1>
                  <span className="font-normal text-muted uppercase">avg monthly</span>
                </div>
                <div>
                  <h1 className="font-normal m-0 mb-1">3</h1>
                  <span className="font-normal text-muted uppercase">avg weekly</span>
                </div>
              </div>
            </Card>
          </Grid>
          ...
          <Grid item lg={4} md={4} sm={12} xs={12}>
            <Card className="p-4 h-full">
              <h4 className="font-medium text-muted pb-6 pb-0 mb-6">Contacts</h4>
          ...
          <Grid item lg={8} md={8} sm={12} xs={12}>
            ...
            <Card className="overflow-unset flex py-4">
              ...
              <div className="flex-grow">
                <div className="flex items-center justify-between pr-4 pb-3">
                  <h5 className="m-0 font-medium capitalize">update profile picture</h5>
            ...
            <Card className="overflow-unset flex py-4">
              <div className="w-100 min-w-100 text-center">
                <Fab
                  className={clsx('relative mt--14', classes.cardLeftVerticalLine)}
                  size="medium"
                  color="primary"
                >
              ...
              <div className="flex-grow">
                <div className="flex items-center justify-between pr-4 pb-3">
                  <h5 className="m-0 font-medium capitalize">bought air ticket</h5>
                  <span className="text-muted">12/03/2019</span>
                </div>
                <Divider />
            ...
            <Card className="overflow-unset flex py-4">
              ...
              <div className="flex-grow">
                <div className="flex items-center justify-between pr-4 pb-3">
                  <h5 className="m-0 font-medium capitalize">timeline box title</h5>
                  <span className="text-muted">12/03/2019</span>
                </div>
                <Divider />
                <p className="m-0 pt-3">
                  ...
                  <div className="py-4 px-6 flex flex-wrap items-center justify-between">
                    <div className="flex flex-wrap items-center">
                      <div className="flex justify-center items-center bg-gray w-64 h-52 border-radius-4">
                        <img className="w-36 overflow-hidden" src={method.img} alt="master card" />
                      </div>
                      <div className="ml-4">
