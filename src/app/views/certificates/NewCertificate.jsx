              ...
              <Grid container spacing={3} alignItems="center">
                ...
                <Grid item md={10} sm={8} xs={12}>
                  <AsyncAutocomplete
                    ...
                    width="100%"
                    asyncSearch={(query) => axios.get(`${Store.getState().host}/v1/admissions/academy/cohort?like=${query}`)}
                ...
                <Grid item md={10} sm={8} xs={12}>
                  <AsyncAutocomplete
                    ...
                    asyncSearch={(query) => axios.get(
                      `${Store.getState().host}/v1/admissions/academy/cohort/user?roles=STUDENT&educational_status=ACTIVE,GRADUATED&like=${query}`,
                    )}
