...
export default function CohortAutoComplete({ addUserTo, cohort_id, button_label, showForm, ...rest }) {
    ...
    const searchCohorts = (searchTerm) => {
        setLoading(true)
    ...
    React.useEffect(() => {
        if (debouncedSearchTerm) {
            searchCohorts(debouncedSearchTerm);
        } else {
            setOptions([]);
        }
