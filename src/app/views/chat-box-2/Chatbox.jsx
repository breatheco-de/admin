...
import ChatAvatar from "app/views/chat-box/ChatAvatar";
import {
  IconButton,
  Icon,
  Divider,
          ...
          >
            ...
            <div className="ml-3">
              {currentUserId !== item.contactId && (
                <h5 className="mt-0 mb-1 text-14">{item.name}</h5>
              )}
              <div
                className={clsx(
          ...
          <div className="ml-3">
            <div className="p-2 mb-2 flex justify-end items-center max-w-240 bg-light-gray border-radius-4 text-14">
              ...
              <div className="ml-3">
                ...
                <span className="text-muted font-medium text-13">21.5KB</span>
              </div>
            </div>
            <span className="text-muted text-13 font-medium">1 minute ago</span>
          </div>
        </div>
      </ScrollBar>
      <div>
          ...
          InputProps={{
            ...
            endAdornment: (
              <div className="flex">
                ...
                <IconButton size="small">
                  <Icon className="text-body">attachment</Icon>
                </IconButton>
              </div>
            ),
