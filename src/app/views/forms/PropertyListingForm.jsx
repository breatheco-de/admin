  ...
  return (
    <Card className="m-sm-30 p-6">
      <div className="max-w-600 mx-auto">
        ...
        <p className="mt-0 mb-1">Have you visited the State previously</p>
        ...
        <p className="mt-0 mb-1">Can we help you make travel arrangements?</p>
        <FormControl component="fieldset" className="mb-4">
          <RadioGroup name="status">
            <FormControlLabel
              className="h-32"
        ...
        <div className="flex justify-center">
          <Button className="px-7" variant="contained" color="primary">
            Submit
          </Button>
        </div>
      </div>
