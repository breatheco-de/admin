...
import {
  Grid, Divider, Card, TextField, Icon, Button, IconButton,
  ...
  <Card className="p-4">
        ...
        <div className="py-3">
          <Grid container>
            <Grid item lg={6} md={6} sm={6} xs={6}>
              <h6 className="m-0 font-medium">Product Details</h6>
            </Grid>
              ...
              <Grid item lg={6} md={6} sm={6} xs={6}>
                <div className="flex">
                  ...
                  <div className="flex-grow">
                    <h6 className="mt-0 mb-3 text-15 text-primary">{product.title}</h6>
    ...
    <Grid container spacing={3}>
      ...
      <Grid item md={5} xs={12}>
        ...
        <p className="text-primary text-13 font-medium mt-0 mb-1">Shipping</p>
        <div className="flex justify-between mb-3">
          <div>
            <p className="m-0">DHL</p>
            <small className="text-muted">Deliver in 1-3 days</small>
          </div>
          <span className="font-medium">$15.00</span>
        </div>

        <p className="text-primary text-13 font-medium mt-0 mb-1">Taxes</p>
