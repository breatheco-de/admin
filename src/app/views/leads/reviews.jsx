...
const Reviews = () => {
  ...
  const studentReviewLink = "https://4geeksacademy.notion.site/Student-Reviews-762eb87ae8d84c26b305d7f5c677776f"
  ...
  return (
    <div className="m-sm-30">
      ...
      <Card style={{backgroundColor: "#d5eaf1"}}className="p-6 mb-5 ">
        <div className="flex items-center bg-light-primary">
          <div style={{ width: '100%' }} className="bg-light-primary">
            <h1>About students review</h1>
            <h5 className="mt-0 mb-2 font-medium ">
          ...
          <a style={{textDecoration: 'underline', color: 'blue' }} href={studentReviewLink} target="_blank">Click here to learn more about reviews.</a>
          </div>
        </div>
      </Card>
