      ...
      <Grid container spacing={2}>
        {list.map((item, index) => (
          <Grid item sm={calculateColumnPerRow(sliderValue)} key={item.id}>
            <Card className={clsx('flex-column h-full', classes.gridCard)} elevation={6}>
              <div className="grid__card-top text-center relative">
                <img className="block w-full" src={item.projectImage} alt="project" />
                <div className="grid__card-overlay flex-column">
                  <div className="flex items-center justify-between">
                    <Checkbox className="text-white" />
                    <div className="flex items-center">
                      <Icon fontSize="small" className="mr-3 cursor-pointer text-white">
                        filter_none
                      </Icon>
                      <Icon fontSize="small" className="mr-3 cursor-pointer text-white">
                        share
                  ...
                  <div className="flex items-center justify-center">
                    <Button variant="outlined" className="text-white border-color-white">
                      View Details
                    </Button>
                  </div>
                </div>
