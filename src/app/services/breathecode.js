...
class BreatheCodeClient {
  ...
  admissions() {
    return {
      ...
      addSyllabus: (payload) =>
        axios.bcPost("Syllabus", `${this.host}/admissions/syllabus`, payload),
      ...
      getAllTimeZone: () =>
        axios.bcGet("TimeZone", `${this.host}/admissions/catalog/timezones`),
      ...
      getAllAcademyTeachers: (query) => {
        ...
        return axios.bcGet(
          "Cohorts",
          `${this.host}/admissions/academy/teacher${query ? `?${qs}` : ""}`
        );
      },
  ...
  auth() {
    return {
      ...
      getAcademyToken: () =>
        axios.bcGet("Academy Token", `${this.host}/auth/academy/token/`),
      postTemporalToken: () =>
      ...
      getGitpodUsers: (query) => {
        ...
        return axios.bcGet(
          "Gitpod Users",
          `${this.host}/auth/academy/gitpod/user${query ? `?${qs}` : ""}`
        );
      },
      ...
      getGithubUsers: (query) => {
        const qs =
          typeof query == "string" ? query : serializeQuerystring(query);
        return axios.bcGet(
          "Gitpod Users",
          `${this.host}/auth/academy/github/user${query ? `?${qs}` : ""}`
        );
      },
      ...
      resendInvite: (user) =>
        axios.bcPut("Invite", `${this.host}/auth/member/invite/resend/${user}`),
      ...
      getMemberInvite: (id) =>
        axios.bcGet("Invite", `${this.host}/auth/academy/member/${id}/invite`),
  ...
  marketing() {
    return {
      ...
      getAcademyAlias: () =>
        axios.bcGet("Academy Id", `${this.host}/marketing/academy/alias`),
      ...
      addNewLead: (newLead) =>
        axios.bcPost("New lead", `${this.host}/marketing/lead`, newLead),
      bulkSendToCRM: (query) => {
        const qs = query.join(",");
        return axios.bcPut(
          "Send to CRM",
    ...
    return {
      ...
      getSingleMentorSessions: (query) => {
        ...
        return axios.bcGet(
          ...
          `${this.host}/mentorship/academy/mentor/${query.mentor}/session${
            query ? `?${qs}` : ""
          }`
        );
      },
  ...
  feedback() {
    return {
      ...
      getReviews: (query) => {
        ...
        return axios.bcGet(
          "Review",
          `${this.host}/feedback/academy/review${query ? `?${qs}` : ""}`
        );
      },
  ...
  events() {
    return {
      ...
      getAcademyEventOrganizer: () =>
        axios.bcGet("Academy event", `${this.host}/events/academy/organizer`),
      ...
      getEventbriteWebhook: (query) => {
        ...
        return axios.bcGet(
          "Eventbrite_Webhook",
          `${this.host}/events/academy/organization/eventbrite/webhook${
            query ? `?${qs}` : ""
          }`
        );
      },
      ...
      getAcademyEventType: () =>
        axios.bcGet("Event Type", `${this.host}/events/academy/eventype`),
      downloadCSV: (query) => {
        const qs = Object.keys(query)
          .map((key) => `${key}=${query[key]}`)
          .join("&");
  ...
  layout() {
    return {
      getDefaultLayout: () =>
        axios.bcGet("Layout", `${this.host}/certificate/academy/layout`),
    };
  }
  monitoring() {
    return {
  ...
  media() {
    return {
      ...
      updateMedia: (media, payload) =>
        axios.bcPut("Media", `${this.host}/media/info/${media}`, payload),
      deleteMedia: (media) =>
        axios.bcDelete("Media", `${this.host}/media/info/${media}`),
      createCategory: (payload) =>
        axios.bcPost("Category", `${this.host}/media/category`, payload),
  ...
  freelance() {
    return {
      getAllProjects: async (query) => {
        ...
        return await axios.bcGet(
          "Project",
          `${this.host}/freelance/academy/project${query ? `?${qs}` : ""}`
        );
      },
      getAllBills: async (query) => {
        ...
        return await axios.bcGet(
          "Project",
          `${this.host}/freelance/academy/bill${query ? `?${qs}` : ""}`
        );
      },
      ...
      generatePendingInvoice: (id) =>
        axios.bcPost(
          "Project Invoice",
          `${this.host}/freelance/academy/project/${id}/invoice`
        ),
      getSingleProject: (id) =>
        axios.bcGet("Project", `${this.host}/freelance/academy/project/${id}`),
      getSingleInvoice: (id) =>
        axios.bcGet("Invoice", `${this.host}/freelance/invoice/${id}`),
      getSingleBill: (id) =>
        axios.bcGet("Payment", `${this.host}/freelance/bills/${id}`),
  ...
  registry() {
    return {
      getAllAssets: async (query) => {
        ...
        return await axios.bcGet(
          "Asset",
          `${this.host}/registry/academy/asset${query ? `?${qs}` : ""}`
        );
      },
      ...
      getAllClusters: async (query) => {
        ...
        return await axios.bcGet(
          "Asset",
          `${this.host}/registry/academy/keywordcluster${query ? `?${qs}` : ""}`
        );
      },
      getAllTechnologies: async (query) => {
        ...
        return await axios.bcGet(
          "Asset",
          `${this.host}/registry/academy/technology${query ? `?${qs}` : ""}`
        );
      },
      getAcademyCategories: async (query) => {
        ...
        return await axios.bcGet(
          "Category",
          `${this.host}/registry/academy/category${query ? `?${qs}` : ""}`
        );
      },
