...
class BreatheCodeClient {
    ...
    auth() {
        return {
            ...
            getMemberInvite: (user) =>
                axios.bcGet('Invite', `${this.host}/auth/academy/user/${user}/invite`),
    ...
    mentorship() {
        return {
            ...
            getSingleMentorSessions: (query) => {
                console.log('getSingleMentorSessions querys', query)
                const qs = serializeQuerystring(query);
                return axios.bcGet(
                    'Academy single mentor sessions',
                    `${this.host}/mentorship/academy/mentor/${query.mentor}/session${query ? `?${qs}` : ''}`,
                );
            },
            getAllAcademyServicesSessions: (querys) => {
                ...
                return axios.bcGet(
                    ...
                    `${this.host}/mentorship/academy/service/${id}/session${query ? `?${qs}` : ''}`,
                );
            },
    ...
    feedback() {
        return {
            ...
            getReviews: () =>
                axios.bcGet('Review', `${this.host}/feedback/academy/review`),
    ...
    registry() {
        return {
            getAsset: (associatedSlug) =>
                axios.bcGet('Asset', `${this.host}/registry/asset/${associatedSlug}`),
        };
    }
