              ...
              <Grid container spacing={2} alignItems="center">
                ...
                <Grid item md={7} sm={4} xs={6}>
                  <TextField
                    ...
                    fullWidth
                    defaultValue={null}
                    value={!values.mime.includes('image') ? values.url : `${Store.getState().host}/v1/media/file/${values.slug}`}
                      ...
                      <Select
                        ...
                        onChange={(e) => {
                          if (e.target.value && e.target.value !== 0) {
                            ...
                            const url = `${Store.getState().host}/v1/media/file/${values.slug}?${Object.keys(query).map((key) => `${key}=${query[key]}`).join('&')}`;
