...
const Layout1Topbar = () => {
  ...
  const updateSettings = (_settings) => {
    dispatch(setLayoutSettings(merge({}, settings, _settings)));
  };
          ...
          <div className="flex items-center">
            ...
            >
              <MenuItem onClick={() => history.push('/session/choose')}>
                <div>
                  ...
                  <p className="m-0 w-100">
                    <small className="d-block">{user.academy?.name}</small>
                  </p>
                  <p className="m-0 w-100">
              ...
              <MenuItem>
                <IconButton>
                  <Switch
                    onChange={() => console.log('settings', settings)
                      || updateSettings({ beta: !settings.beta })}
